...
from tests_e2e.tests.extension_policy.policy_dependencies_cases import _should_fail_sc_depends_on_disallowed_nc
...
class ExtensionPolicyWithDependencies(AgentVmssTest):
    ...
    _test_cases = [
        _should_fail_sc_depends_on_disallowed_nc
    ]

    def _create_policy_file(self, ssh_client, policy):
        with open("waagent_policy.json", mode='w') as policy_file:
            ...
            log.info("Copying policy file to test VM")
    ...
    def run(self):
        ...
        for case in self._test_cases:
            ...
            try:
                ...
                # fail. We know an extension should fail if "fail" is in the case name. Otherwise, report the
                # failure.
                #
...
if __name__ == "__main__":
    ExtensionPolicyWithDependencies.run_from_command_line()
